...
public class GameApi {
    ...
    public void doFire(@PathParam("address") String address) {
        ...
        game.ifPresent(g -> {
            ...
            User oppostionUser = g.getStrike(currentUser);
            Optional<Cell> oposCell = gameStore.findCell(g, oppostionUser, address, false);
            CellState oposCellState;
            if(oposCell.isPresent()) {
                oposCellState = oposCell.get().getState();
            }
